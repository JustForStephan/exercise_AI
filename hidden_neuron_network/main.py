...
for running_index in range(100):
    ...
    for i in range(len(x)):
        neuron1 = copy.deepcopy(neuron([x[i]],[w[1][0]]))
        neuron2 = copy.deepcopy(neuron([1],[w[1][1]]))
        neuron3 = copy.deepcopy(neuron([neuron1.y, neuron2.y], [w[1][0], w[2][0]]))
        neuron4 = copy.deepcopy(neuron([neuron1.y, neuron2.y], [w[1][1], w[2][1]]))
        neuron5 = copy.deepcopy(neuron([neuron3.y, neuron4.y], [w[3], w[4]]))
        e = y[i] - neuron5.y
        #print(e)
